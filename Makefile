...
#---------------------------------------------------------------------------------
LIBS	:= -lcrt -lcoreinit -lproc_ui -lnsysnet -lsndcore2 -lvpad -lgx2 -lsysapp -lgd -lpng -lz -lfreetype -lmad -lvorbisidec -liosuhax -lzip -lz
...
NUSPacker.jar:
	wget --no-check-certificate https://bitbucket.org/timogus/nuspacker/downloads/NUSPacker.jar -O NUSPacker.jar
